    ...
    <div class="panel page-header page-header-xs border-bottom-teal">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h6>
                    <span class="text-semibold">Edit Multiple Select Single Correct Answer Question</span>
            ...
            <div class="panel-body">
                <div class="tabbable">
                    <div class="slide-header">
                        <h3>Edit Multiple Select Single Correct Answer Question Form</h3>
                    </div>
                    <!-- //slide header -->

                    {!! Form::model($multiple_select_single, ['method' => 'PATCH', 'route' => ['e-learning.questions.multiple-select-single-question-update', $multiple_select_single->id]]) !!}
