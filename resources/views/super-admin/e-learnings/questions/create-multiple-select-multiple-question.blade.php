    ...
    <div class="panel page-header page-header-xs border-bottom-teal">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h6>
                    <span class="text-semibold">Add Multiple Select Multiple Correct Answer Question</span>
            ...
            <div class="panel-body">
                <div class="tabbable">
                    <div class="slide-header">
                        <h3>Add Multiple Select Multiple Correct Answer Question Form</h3>
                    </div>
                    <!-- //slide header -->

                    {!! Form::open(['route' => 'e-learning.questions.multiple-select-multiple-question-store' ]) !!}
