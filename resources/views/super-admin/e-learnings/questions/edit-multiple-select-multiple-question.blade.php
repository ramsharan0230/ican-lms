    ...
    <div class="panel page-header page-header-xs border-bottom-teal">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h6>
                    <span class="text-semibold">Edit Multiple Select Multiple Correct Answer Question</span>
            ...
            <div class="panel-body">
                <div class="tabbable">
                    <div class="slide-header">
                        <h3>Edit Multiple Select Multiple Correct Answer Question Form</h3>
                    </div>
                    <!-- //slide header -->

                    {!! Form::model($multiple_select_multiple, ['method' => 'PATCH', 'route' => ['e-learning.questions.multiple-select-multiple-question-update', $multiple_select_multiple->id]]) !!}
                    @include('super-admin.e-learnings.questions.partials.partial-multiple-select-multiple-question')
                    {!! Form::close() !!}<!-- form -->
                </div>
                <!-- tabbable -->
            </div>
