    ...
    <div class="panel page-header page-header-xs border-bottom-teal">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h6>
                    <span class="text-semibold">Courses List</span>
                    <span class="pull-right custom-breadcrumb">
                         ...
                         <ul class="breadcrumb">
                             ...
                             <li><a href="{{ route('e-learning.courses.index') }}">Courses</a></li>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                <a href="{{ route('e-learning.courses.create') }}" class="btn btn-info btn-lg"><i class="icon-add"></i> &nbsp;&nbsp;Add New Course</a>
            </div>
            ...
            <table class="table datatable-column-search-inputs">
                ...
                @foreach($courses as $course)
                            ...
                            <ul class="icons-list">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="{{ route('e-learning.courses.show', [$course->id]) }}"> <i class="icon-search4"></i>
                                                <span class="text-info">View</span></a></li>
                                        <li><a href="{{ route('e-learning.courses.edit', [$course->id]) }}"><i
                                                        class="icon-database-edit2"></i> <span
                                                        class="text-info">Edit</span></a></li>
                                        <li><a href="#" data-toggle="modal" data-target="#modal_delete_course"><i class="icon-database-remove"></i> <span class="text-danger">Delete</span></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div id="modal_delete_course" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content bg-danger">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {{ Form::open(array('route' => array('e-learning.courses.destroy', $course->id), 'method' => 'delete')) }}
