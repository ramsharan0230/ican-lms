    ...
    <div class="panel page-header page-header-xs border-bottom-teal">
        ...
        <div class="page-header-content">
            <div class="page-title">
                <h6>
                    <span class="text-semibold">View Course</span>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default" id="lesson-tab-panel-1">
                <div class="panel-heading">
                    <h6 class="panel-title">{{ $course->name }}</h6>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    @foreach($course_lessons as $lesson)
                                        <li>
                                            <a href="{{ route('e-learning.lessons.show', $lesson->lesson_id) }}"><i class="icon-people"></i> {{ $lesson->lesson_name }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                ...
                <div class="panel-tab-content tab-content">
                    <div class="tab-pane active has-padding disable-select div-scroll">
                        <a href="{{ route('e-learning.courses.edit', $course->id) }}"
